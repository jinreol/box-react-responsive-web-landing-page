...
function FirstBlockComp01() {
  return (
    <div className="bg-accent-10 border-accent-25 rounded-100 flex max-w-374 items-center gap-16 border border-solid px-24 py-12 md:pt-8 md:pr-24 md:pb-8 md:pl-8">
